...
def train_evaluate_model(model, model_name):
    ...
    rounded_accuracy = np.round(accuracy, 5)
    ...
    return {'model_name': model_name, 'accuracy': rounded_accuracy, 'confusion_matrix': cm, 'model_filename': model_filename}
...
predict_on_new_data(joblib.load(best_model_result['model_filename']), best_model_name)
