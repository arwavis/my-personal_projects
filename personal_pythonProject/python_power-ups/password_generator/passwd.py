...
application_name = input("Enter the application that you will be setting up this password for: ")
...
print(f"{application_name} password is : {password} and this password was generated on {textual_month_format}")

with open('/Users/aravindv/Documents/code/github/password.txt', 'a') as f:
    print(f"{application_name} password is : {password} and this password was generated on {textual_month_format}", file=f)
